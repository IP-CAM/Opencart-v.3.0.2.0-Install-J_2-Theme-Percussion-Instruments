...
/* journal2/template/extension/total/coupon.twig */
class __TwigTemplate_d1d8c6a19e24df2c614da2d2cc828f1b6b4dee2d1cacb40af23e6d2cd826a5a6 extends Twig_Template
{
    ...
    {
        // line 1
        echo "<div class=\"panel panel-default sc-coupon\">
...
";
    ...
    {
        return "journal2/template/extension/total/coupon.twig";
    }
...
/*         <span class="input-group-btn">*/
/*         <input type="button" value="{{ button_coupon }}" id="button-coupon" data-loading-text="{{ text_loading }}"  class="btn btn-primary button" />*/
/*         </span></div>*/
/*       <script type="text/javascript"><!--*/
/* $('#button-coupon').on('click', function() {*/
/* 	$.ajax({*/
