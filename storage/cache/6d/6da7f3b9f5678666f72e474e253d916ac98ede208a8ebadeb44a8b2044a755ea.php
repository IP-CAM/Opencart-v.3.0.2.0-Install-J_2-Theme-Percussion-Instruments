...
/* journal2/template/extension/total/shipping.twig */
class __TwigTemplate_95fb52cb1d8441cedc88252470eb8c498109f0e4266313c17672ecb72348c43c extends Twig_Template
{
    ...
    {
        // line 1
        echo "<div class=\"panel panel-default sc-shipping\">
...
\t\t\t\t\t\$('.breadcrumb').after('<div class=\"alert alert-danger alert-dismissible warning\"><i class=\"fa fa-exclamation-circle\"></i> ' + json['error']['warning'] + '<button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button></div>');
...
\t\t\t\t\t\t}
\t\t\t\t\t} else {
\t\t\t\t\t\thtml += '<div class=\"alert alert-danger alert-dismissible warning\">' + json['shipping_method'][i]['error'] + '</div>';
\t\t\t\t\t}
\t\t\t\t}

\t\t\t\thtml += '      </div>';
\t\t\t\thtml += '      <div class=\"modal-footer\">';
\t\t\t\thtml += '        <button type=\"button\" class=\"btn btn-default button\" data-dismiss=\"modal\">";
        // line 109
...
\t\t\t\t";
            ...
            echo "\" id=\"button-shipping\" data-loading-text=\"";
            echo (isset($context["text_loading"]) ? $context["text_loading"] : null);
            echo "\" class=\"btn btn-primary button\" disabled=\"disabled\" />';
\t\t\t\t";
        }
        // line 116
        echo "
...
\t\t\tif (json['error']) {
\t\t\t\t\$('.breadcrumb').after('<div class=\"alert alert-danger alert-dismissible warning\"><i class=\"fa fa-exclamation-circle\"></i> ' + json['error'] + '<button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button></div>');
...
";
    ...
    {
        return "journal2/template/extension/total/shipping.twig";
    }
...
/* <div class="panel panel-default sc-shipping">*/
/*   <div class="panel-heading">*/
...
/*           </div>*/
/*         </div>*/
/*         <button type="button" id="button-quote" data-loading-text="{{ text_loading }}" class="btn btn-primary button">{{ button_quote }}</button>*/
/*       </div>*/
/*       <script type="text/javascript"><!--*/
/* $('#button-quote').on('click', function() {*/
/* 	$.ajax({*/
...
/* 				html += '      </div>';*/
/* 				html += '      <div class="modal-footer">';*/
/* 				html += '        <button type="button" class="btn btn-default button" data-dismiss="modal">{{ button_cancel }}</button>';*/
/* */
/* 				{% if shipping_method %}*/
/* 				html += '        <input type="button" value="{{ button_shipping }}" id="button-shipping" data-loading-text="{{ text_loading }}" class="btn btn-primary button" />';*/
/* 				{% else %}*/
/* 				html += '        <input type="button" value="{{ button_shipping }}" id="button-shipping" data-loading-text="{{ text_loading }}" class="btn btn-primary button" disabled="disabled" />';*/
/* 				{% endif %}*/
/* */
/* 				html += '      </div>';*/
/* 				html += '    </div>';*/
