...
/* journal2/template/checkout/login.twig */
class __TwigTemplate_59aa07cfdd20c8aca4c661542a738105d1f935c4a9331201f2beb0ebb0c7da24 extends Twig_Template
{
...
";
    ...
    {
        return "journal2/template/checkout/login.twig";
    }
...
/*     <input type="button" value="{{ button_continue }}" id="button-account" data-loading-text="{{ text_loading }}" class="btn btn-primary button" />*/
/*   </div>*/
/*   <div class="col-sm-6 right">*/
...
/*     <input type="button" value="{{ button_login }}" id="button-login" data-loading-text="{{ text_loading }}" class="btn btn-primary button" />*/
/*   </div>*/
/* </div>*/
/* */
