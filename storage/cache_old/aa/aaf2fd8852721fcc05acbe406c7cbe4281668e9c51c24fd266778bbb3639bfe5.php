...
class __TwigTemplate_811f01015b2fa6ce5df94c7254a0179f121720317a892b2afe2c05f1a4501199 extends Twig_Template
{
...
/* {% endfor %}*/
/* <script>*/
/* {% if journal2.settings.get('show_countdown', 'never') is not same as('never') or journal2.settings.get('show_countdown_product_page', 'on') is not same as('on') %}*/
/* Journal.COUNTDOWN = {*/
