...
/* journal2/template/extension/total/voucher.twig */
class __TwigTemplate_f4f40be05f5191b3df57f0b6246e59e84585df2b08072e059230c1206953f063 extends Twig_Template
{
    ...
    {
        // line 1
        echo "<div class=\"panel panel-default sc-voucher\">
...
";
    ...
    {
        return "journal2/template/extension/total/voucher.twig";
    }
...
/* <div class="panel panel-default sc-voucher">*/
/*   <div class="panel-heading">*/
...
/*         <span class="input-group-btn">*/
/*         <input type="submit" value="{{ button_voucher }}" id="button-voucher" data-loading-text="{{ text_loading }}"  class="btn btn-primary button" />*/
/*         </span> </div>*/
/*       <script type="text/javascript"><!--*/
/* $('#button-voucher').on('click', function() {*/
/* 	$.ajax({*/
