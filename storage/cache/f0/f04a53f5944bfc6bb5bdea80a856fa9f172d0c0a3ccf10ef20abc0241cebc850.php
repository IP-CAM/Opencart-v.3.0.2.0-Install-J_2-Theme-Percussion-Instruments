...
class __TwigTemplate_b2d4c727aedeaadea6cdc711bddb1698034622c0483b585254cd7dc2686b46da extends Twig_Template
{
...
<script>
  ...
  ";
        ...
        if (($this->getAttribute($this->getAttribute((isset($context["journal2"]) ? $context["journal2"] : null), "settings", array()), "get", array(0 => "one_page_auto_save", 1 => "0"), "method") == "1")) {
            // line 671
            echo "  \$('.journal-checkout input').on('blur', function () {
    var data = {};
